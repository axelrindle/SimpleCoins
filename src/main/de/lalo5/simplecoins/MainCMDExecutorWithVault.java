 ...
 */
public class MainCMDExecutorWithVault implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if(sender instanceof Player) {
            ...
            if(cmd.getName().equalsIgnoreCase("sc")) {
                if(SimpleCoins.perms.has(p, Perms.MAIN.perm())) {
                    if(args.length == 0) {
                        ...
                        if(SimpleCoins.perms.has(p, Perms.ADD.perm())) {
                            if(args.length == 3) {
                                ...
                                if(p_ != null) {
                                    ...
                                    EconomyResponse r = SimpleCoins.econ.depositPlayer(p, amount);
                                    if(r.transactionSuccess()) {
                                        p_.sendMessage(String.format("You were given %s and now have %s", SimpleCoins.econ.format(r.amount), SimpleCoins.econ.format(r.balance)));
                                    } else {
                        ...
                        if(SimpleCoins.perms.has(p, Perms.REMOVE.perm())) {
                            if(args.length == 3) {
                        ...
                        if(SimpleCoins.perms.has(p, Perms.SET.perm())) {
                            if(args.length == 3) {
                        ...
                        if(args.length == 2) {
                            if(SimpleCoins.perms.has(p, Perms.GETOTHER.perm())) {
                            ...
                            if(SimpleCoins.perms.has(p, Perms.GETSELF.perm())) {
                        ...
                        if(SimpleCoins.perms.has(p, Perms.RELOAD.perm())) {
                            if(args.length == 1) {
                                try {
                        ...
                        if(SimpleCoins.perms.has(p, Perms.SYNC.perm())) {
                            if(args.length == 2) {
