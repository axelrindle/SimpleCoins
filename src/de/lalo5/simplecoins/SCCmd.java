                ...
                if(p.hasPermission(Perms.MAIN.perm())) {
                    if(args.length == 0) {
                        ...
                        if(p.hasPermission(Perms.ADD.perm())) {
                            if(args.length == 3) {
                                ...
                                if(p_ != null) {
                                    ...
                                    if(vaultEnabled && econ != null) {
                                        ...
                                        if(r.transactionSuccess() && cfg.getBoolean("UseVaultMessages")) {
                            ...
                            p.sendMessage(SimpleCoins.colorize(prefix + cfg.getString("Messages.NoPermission")));
                            return true;
                        }
                            ...
                            if(args.length == 3) {
                                ...
                                if(p_ != null) {
                                    ...
                                    if(now != 0) {
                                        ...
                                        p.sendMessage(SimpleCoins.colorize(prefix + "&cPlayer " + p_.getName() +  "has 0 &9" + cfg.getString("CoinsName") + "&c!"));
                                    }
                                } else {
                                    p.sendMessage(SimpleCoins.colorize(prefix + "&cThis player does not exist!"));
                                }
                                ...
                                if(!vaultEnabled) {
                                    try {
                                        if(SimpleCoins.useSQL) {
                                            ...
                                            cfg.save(SimpleCoins.configfile);
                                            cfg = YamlConfiguration.loadConfiguration(SimpleCoins.configfile);
                                            CoinManager.saveFiles();
                                            CoinManager.loadFiles();
                                        }

                                        p.sendMessage(SimpleCoins.colorize(prefix + cfg.getString("Messages.Reload")));
